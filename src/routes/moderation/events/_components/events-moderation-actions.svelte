...
<DropdownMenu.Root>
	...
	<DropdownMenu.Content>
		<DropdownMenu.Item href="/events/{id}">Open</DropdownMenu.Item>
...
<Dialog.Root bind:open={openApproveDialog}>
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			<Dialog.Title>Aprovar Evento</Dialog.Title>
			<Dialog.Description>Tens a certeza de que queres aprovar este evento?</Dialog.Description>
		</Dialog.Header>
...
<Dialog.Root bind:open={openRejectDialog}>
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			<Dialog.Title>Rejeitar Evento</Dialog.Title>
			<Dialog.Description>Tens a certeza de que queres rejeitar este evento?</Dialog.Description>
		</Dialog.Header>
		<form method="POST" use:enhance>
			<input type="hidden" name="ref_id" value={id} />
			<input type="hidden" name="user_id" value={userId} />
...
<Dialog.Root bind:open={openRequestChangesDialog}>
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			...
			<Dialog.Description
				>Tens a certeza de que queres solicitar alterações para este evento?</Dialog.Description
			>
		</Dialog.Header>
		<form method="POST" use:enhance>
			<input type="hidden" name="ref_id" value={id} />
