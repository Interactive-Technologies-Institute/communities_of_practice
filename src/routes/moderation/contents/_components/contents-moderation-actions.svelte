...
<DropdownMenu.Root>
	...
	<DropdownMenu.Content>
		<DropdownMenu.Item href="/contents/{id}">Open</DropdownMenu.Item>
...
<Dialog.Root bind:open={openApproveDialog}>
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			<Dialog.Title>Approve Content</Dialog.Title>
			<Dialog.Description>Are you sure you want to approve this Content?</Dialog.Description>
		</Dialog.Header>
...
<Dialog.Root bind:open={openRejectDialog}>
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			<Dialog.Title>Reject Content</Dialog.Title>
			<Dialog.Description>Are you sure you want to reject this Content?</Dialog.Description>
		</Dialog.Header>
		<form method="POST" use:enhance>
			<input type="hidden" name="ref_id" value={id} />
			<input type="hidden" name="user_id" value={userId} />
...
<Dialog.Root bind:open={openRequestChangesDialog}>
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			...
			<Dialog.Description
				>Are you sure you want to request changes for this Content?</Dialog.Description
			>
		</Dialog.Header>
		<form method="POST" use:enhance>
			<input type="hidden" name="ref_id" value={id} />
