...
<MetaTags title="Eventos" description="Encontra e partilha eventos da comunidade" />

<!--<PageHeader title="Eventos" subtitle="Encontra e partilha eventos da comunidade" />-->
