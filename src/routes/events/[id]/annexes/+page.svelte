...
<MetaTags title="Event Annexes" description="Annex the event with contents, threads and other events" />

<PageHeader title="Event Annexes" subtitle="Annex the event with contents, threads and other events" />
