...
<MetaTags title="Content Connections" description="Connect the content with events, threads and other contents" />

<PageHeader title="Content Connections" subtitle="Connect the content with events, threads and other contents" />
