...
values ('user', 'guides.create'),
	...
	('user', 'event_events.create'),
	('user', 'event_events.delete'),
	('user', 'event_threads.create'),
	('user', 'event_threads.delete'),
	('user', 'content_contents.create'),
	('user', 'content_contents.delete'),
	('user', 'content_events.create'),
	('user', 'content_events.delete'),
	('user', 'content_threads.create'),
	('user', 'content_threads.delete'),
	...
	('moderator', 'event_events.create'),
	('moderator', 'event_events.delete'),
	('moderator', 'event_threads.create'),
	('moderator', 'event_threads.delete'),
	('moderator', 'content_contents.create'),
	('moderator', 'content_contents.delete'),
	('moderator', 'content_events.create'),
	('moderator', 'content_events.delete'),
	('moderator', 'content_threads.create'),
	('moderator', 'content_threads.delete'),
	...
	('admin', 'event_events.create'),
	('admin', 'event_events.delete'),
	('admin', 'event_threads.create'),
	('admin', 'event_threads.delete'),
	('admin', 'content_contents.create'),
	('admin', 'content_contents.delete'),
	('admin', 'content_events.create'),
	('admin', 'content_events.delete'),
	('admin', 'content_threads.create'),
	('admin', 'content_threads.delete');